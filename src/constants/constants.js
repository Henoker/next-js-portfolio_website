export const projects = [
  {
    ...
    image: '/images/EPMS.PNG',
    tags: ['Docker', 'Django', 'postgSQL'],
    source: 'https://github.com/Henoker/epms',
    visit: 'https://github.com/Henoker/epms',
    id: 4,
  },
  {
  ...
  {
    title: 'EPHIE CUISINE',
    description:"This is a next js restaurant landing page app which is made for my client who resides in fremont, california. The contact section backend is handled by google app engine.",
    image: '/images/EPHIE.png',
    tags: ['Next Js', 'Google App Engine', 'CSS'],
    source: 'https://github.com/Henoker/ephiecuisine',
...
export const TimeLineData = [
  ...
  { year: 2019, text: 'Co-Founded Ethiostar Translaion & Localization PLC', },
